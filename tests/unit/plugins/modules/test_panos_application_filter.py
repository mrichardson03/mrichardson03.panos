        ...
        "entry": [
            {
                ...
                "@location": "vsys",
                "@vsys": "vsys1",
                "category": {"member": ["business-systems", "collaboration"]},
                "subcategory": {"member": ["auth-service"]},
                "technology": {"member": ["client-server"]},
                "risk": {"member": ["1", "2"]},
            }
        ],
    },
...
class TestPanosApplicationFilter(ModuleTestCase):
    ...
    modify_result = {
        "@name": "Test",
        "category": {"member": ["business-systems"]},
        "subcategory": {"member": ["auth-service"]},
        "technology": {"member": ["client-server"]},
        "risk": {"member": ["5"]},
        "is-saas": "yes",
