...
from ansible_collections.mrichardson03.panos.plugins.modules import panos_tag_object
...
GET_RESPONSE = {
    ...
    "result": {
        ...
        "@count": "1",
        "entry": [
            {"@name": "Test", "@location": "vsys", "@vsys": "vsys1", "color": "color1"}
        ],
    },
}


class TestPanosTagObject(ModuleTestCase):
    module = panos_tag_object

    response = GET_RESPONSE

    create_args = {"name": "Test", "color": "red"}
    ...
    modify_result = {"@name": "Test", "color": "color2"}
